# This file is a harmless lab source mapped to '70700.4_정상_시스템_도구(LOLBins)_활용_사례'.
"""Defensive training source for: 70700.4_정상_시스템_도구(LOLBins)_활용_사례."""
...
TOPIC = '70700.4_정상_시스템_도구(LOLBins)_활용_사례'
