# This file is a harmless lab source mapped to '70710.4_메모리_인젝션_및_쉘코드_실행_분석'.
"""Defensive training source for: 70710.4_메모리_인젝션_및_쉘코드_실행_분석."""
...
TOPIC = '70710.4_메모리_인젝션_및_쉘코드_실행_분석'
